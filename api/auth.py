...
def users():
    if current_user.admin:
        ...
        return render_template("admin/users.html", current_user=current_user, page="users", users=users)
    else:
        abort(403)
...
def adduser():
    if current_user.admin:
        ...
        return render_template("admin/adduser.html", current_user=current_user, page="adduser")
    else:
        abort(403)
...
def edituser(userid):
    if current_user.admin:
        ...
        return render_template("admin/edituser.html", current_user=current_user, page="edituser", user=user)
    else:
        abort(403)
